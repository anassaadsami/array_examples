...
public class Players {
	...
	public Players(String name, char ch) {
		this.name = name;
		this.ch = ch;
	...
	public static void main(String[] args) {
		...
		Players t1 = new Players("player1", 'X');
		Players t2 = new Players("player2", '0');
	...
	// method to take a choice from every player but must be within range 1...9 and
	// just numbers otherwise it throws exceptions
	...
	// method to check if player's choices have this standard win numbers so it will
	// be break and this player wins
